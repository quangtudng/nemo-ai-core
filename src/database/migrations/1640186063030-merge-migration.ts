...
export class mergeMigration1640186063030 implements MigrationInterface {
    name = 'mergeMigration1640186063030'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE \`nemo_dev\`.\`messages\` (\`created_at\` timestamp(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6), \`updated_at\` timestamp(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6) ON UPDATE CURRENT_TIMESTAMP(6), \`id\` int NOT NULL AUTO_INCREMENT, \`body\` text NOT NULL, \`type\` tinyint NOT NULL, \`owner\` varchar(255) NOT NULL, \`interest_results\` text NULL, \`customer_id\` int NULL, PRIMARY KEY (\`id\`)) ENGINE=InnoDB`);
        await queryRunner.query(`CREATE TABLE \`nemo_dev\`.\`customers\` (\`created_at\` timestamp(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6), \`updated_at\` timestamp(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6) ON UPDATE CURRENT_TIMESTAMP(6), \`id\` int NOT NULL AUTO_INCREMENT, \`long_id\` text NULL, \`email\` varchar(100) NULL, \`ip\` varchar(50) NULL, \`location\` varchar(50) NULL, \`viewed\` tinyint NOT NULL DEFAULT '0', \`current_stage\` text NULL, \`pass_stages\` text NULL, PRIMARY KEY (\`id\`)) ENGINE=InnoDB`);

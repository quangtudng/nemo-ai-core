...
export class mergeMigration1644046386439 implements MigrationInterface {
    name = 'mergeMigration1644046386439'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE \`nemo_dev\`.\`locations\` (\`created_at\` timestamp(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6), \`updated_at\` timestamp(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6) ON UPDATE CURRENT_TIMESTAMP(6), \`id\` int NOT NULL AUTO_INCREMENT, \`name\` varchar(100) NOT NULL, \`type\` varchar(100) NOT NULL, \`slug\` varchar(100) NOT NULL, \`description\` text NULL, \`latitude\` float NOT NULL DEFAULT '0', \`longitude\` float NOT NULL DEFAULT '0', \`mpath\` varchar(255) NULL DEFAULT '', \`parent_id\` int NULL, PRIMARY KEY (\`id\`)) ENGINE=InnoDB`);
